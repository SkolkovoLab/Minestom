...
//            logger.debug("chunk batch sent player={} chunks={} lead={}", username, batchSize, chunkBatchLead);
    ...
    public void setListed(boolean listed) {
        this.listed = listed;
        if (isActive()) {
            sendPacketToViewersAndSelf(new PlayerInfoUpdatePacket(PlayerInfoUpdatePacket.Action.UPDATE_LISTED, infoEntry()));
        }
    }
    ...
    public void setListOrder(int listOrder) {
        ...
        if (isActive()) {
            sendPacketToViewersAndSelf(new PlayerInfoUpdatePacket(PlayerInfoUpdatePacket.Action.UPDATE_LIST_ORDER, infoEntry()));
        }
    }
